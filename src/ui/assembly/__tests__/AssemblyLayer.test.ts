...
describe('AssemblyLayer', () => {
  it('calculates height as thicknessMm * scalePixelsPerMm', () => {
    const wrapper = mount(AssemblyLayer, {
      props: { hatchType: 'concrete', thicknessMm: 150, x: 60, y: 0, width: 300, scalePixelsPerMm: 0.5 },
    })
  ...
  it('renders at least 2 rect elements', () => {
    const wrapper = mount(AssemblyLayer, {
      props: { hatchType: 'wood', thicknessMm: 100, x: 60, y: 10, width: 400, scalePixelsPerMm: 1 },
    })
    const rects = wrapper.findAll('rect')
  ...
  it('positions layer at correct y offset', () => {
    const wrapper = mount(AssemblyLayer, {
      props: { hatchType: 'steel', thicknessMm: 50, x: 60, y: 20, width: 200, scalePixelsPerMm: 2 },
    })
    const rects = wrapper.findAll('rect')
